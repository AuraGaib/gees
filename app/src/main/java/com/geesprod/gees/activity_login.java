...
import com.geesprod.gees.Model.Users;
    ...
    private void AllowAccessToAccount(final String phone, final String password)
    {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                            if (parentDbName.equals("Admins"))
                            {
                                ...
                                Intent intent = new Intent(activity_login.this, activity_admin_katagori.class);
                                startActivity(intent);
                            }
                            else if (parentDbName.equals("Akun"))
                            {
                                Toast.makeText(activity_login.this, "logged in Successfully...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();

                                Intent intent = new Intent(activity_login.this, activity_home_user.class);
                ...
                {
                    Toast.makeText(activity_login.this, "Account with this " + phone + " number do not exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
